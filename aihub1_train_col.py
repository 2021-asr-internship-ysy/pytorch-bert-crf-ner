...
def main(parser):
    #config, vocab, tokenizer=KoBERT, model=aihub
    # Config
    ...
    vocab_file="./ptr_lm_model/kobertvocab_f38b8a4d6d.json"
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % model_config.gradient_accumulation_steps == 0:
                ...
                if model_config.save_steps > 0 and global_step % model_config.save_steps == 0:
                    ...
                    o_dir="/home/hoya/notebooks/syoung21.yoo/aihub1_model_output/"
                    # Save model checkpoint
                    output_dir = os.path.join(o_dir, 'aihub1_epoch-{}'.format(epoch + 1))
                    ...
                    if is_best:
                        ...
                        cr_save_path = "/home/hoya/notebooks/syoung21.yoo/aihub1_model_output/best_epoch" / 'best-epoch-{}-step-{}-acc-{:.3f}-cr.csv'.format(epoch + 1, global_step, best_dev_acc)
                        cm_save_path = "/home/hoya/notebooks/syoung21.yoo/aihub1_model_output/best_epoch" / 'best-epoch-{}-step-{}-acc-{:.3f}-cm.png'.format(epoch + 1, global_step, best_dev_acc)
