...
def main(parser):
    ...
    checkpoint = torch.load("/workspace/data/base_model_with_crf_val/best-epoch-12-step-1000-acc-0.960.bin", map_location=torch.device('cpu'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_dir', default='/workspace/data/base_model_with_crf_val', help="Directory containing config.json of model")
